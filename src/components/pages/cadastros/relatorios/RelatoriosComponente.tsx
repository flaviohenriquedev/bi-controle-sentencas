...
export function RelatoriosComponente() {
    ...
    return (
        <Pagesection.Container titulo={`Relatórios`}>
            <LineContent>
                <GerarRelatorioComponent descricao={`Listagem de Clientes`}
                                         action={() => handlePrint("LISTAGEM_CLIENTES")}/>
                <GerarRelatorioComponent descricao={`Listagem de Usuários`}
